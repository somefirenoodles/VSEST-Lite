...
|---|---|---|---|---|---|
| EV-006 | Adecuacion funcional | El producto PSIREG permite ejecutar los flujos funcionales principales definidos para citas, expedientes, documentos y roles. | Pendiente por ausencia de sistema implementado | 0 - No cumple | No se puede validar adecuacion funcional porque PSIREG no esta implementado. El resultado se mantiene en 0 hasta contar con host funcional o evidencia ejecutable. |
